    ...
    <>
      <div className="bg-gray-100 min-h-screen py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto bg-white p-8 rounded-lg shadow-xl">
          ...
          <ul className="list-disc list-inside space-y-4 text-gray-700 mb-8">
            ...
            <li>
              <p>
                ...
                or &quot;Our&quot; in this Agreement) refers to CalEasy.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong className="font-semibold">Service</strong> refers to the
                Website.
              </p>
            </li>
            <li>
              <p>
                <strong className="font-semibold">Terms and Conditions</strong>{' '}
            ...
            <li>
              <p>
                <strong className="font-semibold">Website</strong> refers to
                CalEasy, accessible from
                <a
                  href="https://www.CalEasy.me"
                  rel="external nofollow noopener"
                  target="_blank"
                  className="text-blue-600 hover:underline"
                >
                  https://www.CalEasy.me
                </a>
              </p>
            </li>
            <li>
          ...
          <h3 className="text-xl font-medium text-gray-700 mb-2">Waiver</h3>
          <p className="text-gray-700 mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700">
            <li>By email: fudail.zafar@gmail.com</li>
          </ul>
        </div>
      </div>
    </>
